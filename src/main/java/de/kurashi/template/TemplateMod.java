 ...
 * Hytale Mod Template.
 *
 * <p>Lifecycle: 1. Constructor - JAR wird geladen, super(init) aufrufen 2. setup() - Events,
 * ECS-Systeme registrieren (Server noch nicht bereit) 3. start() - Server bereit, Commands
 * registrieren, Scheduler starten 4. shutdown() - Server stoppt, Ressourcen freigeben (DB
 * schliessen, Tasks canceln)
 *
 * <p>Package-Layout: de.kurashi.template — Plugin Entry de.kurashi.template.events — Event-Handler
